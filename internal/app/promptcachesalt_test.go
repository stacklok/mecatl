...
// TestADR_0343_CacheKeySaltedPerProcess pins the composition half of AC3.1: each
...
// key on the wire — is TestADR_0343_CacheKeySaltChangesKey in provider/openai.
func TestADR_0343_CacheKeySaltedPerProcess(t *testing.T) {
...
// TestADR_0343_CacheKeySaltNeverPersistedOrLogged pins AC3.3 structurally: the
...
func TestADR_0343_CacheKeySaltNeverPersistedOrLogged(t *testing.T) {
	cfg := orCfg()
...
// TestADR_0343_OpenAICompatEntryRefusesRedirect pins AC5.1 for a generic
...
// (internal/requestconfig/origin.go), and ADR 0343 additionally gives the entry
...
func TestADR_0343_OpenAICompatEntryRefusesRedirect(t *testing.T) {
