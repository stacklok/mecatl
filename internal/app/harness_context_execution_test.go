...
func TestADR_0354_HarnessContext_Scenario1_UnselectedExecutionContentIgnored(t *testing.T) {
...
func TestADR_0354_HarnessContext_Scenario1_ExplicitExecutionFileSource(t *testing.T) {
...
func TestADR_0354_HarnessContext_Scenario2_SourceOnlyDiscovery(t *testing.T) {
...
func TestADR_0354_HarnessContext_Scenario3_SourceReadsDoNotAuthorizeEdits(t *testing.T) {
