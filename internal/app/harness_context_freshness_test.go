...
func TestADR_0354_HarnessContext_Scenario3_ProjectInstructionsPerRun(t *testing.T) {
...
func TestADR_0354_HarnessContext_Scenario3_RootDiscoveryCompatibility(t *testing.T) {
...
func TestADR_0354_HarnessContext_Scenario2_SelectedCommandsRemainLive(t *testing.T) {
