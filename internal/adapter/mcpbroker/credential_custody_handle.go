...
//
//nolint:gocyclo // one ordered admission/validation transaction over the staged custody request.
func (a *Attachment) StageCredentialCustody(ctx context.Context, requestID string, guard contract.ContinuityGuard, enrollment contract.WorkspaceEnrollmentRef, deadline time.Time) (contract.StagedCredentialCustody, error) {
...
func (a *Attachment) CredentialContinuity() bool {
...
var (
	_ contract.CredentialCustodyStager        = (*Attachment)(nil)
	_ contract.CredentialContinuityAdvertiser = (*Attachment)(nil)
)
