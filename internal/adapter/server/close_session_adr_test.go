...
func TestADR_0294_CloseGRPCAndHTTPRejectLiveOrAwaitingRun(t *testing.T) {
...
func TestADR_0294_CloseGRPCAndHTTPPreservePersistedAwaitingResumePoint(t *testing.T) {
