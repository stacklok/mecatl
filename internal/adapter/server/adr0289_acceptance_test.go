...
func TestADR_0289_ScopedWorktreeSelectorsFailClosed(t *testing.T) {
...
func TestADR_0289_NoFSDiscoveryDoesNotInvokeFilesystemProviders(t *testing.T) {
	store := &placementStoreSpy{Store: memstore.New()}
	provider := &placementProviderSpy{}
...
func TestADR_0289_ClearSessionIsLeaseSafeAndNonDestructive(t *testing.T) {
	store := &placementStoreSpy{Store: memstore.New()}
	provider := &placementProviderSpy{}
