...
// TestADR_0290_ScheduleResolvesSelectorBeforePersistingExactEnvironmentRef
...
func TestADR_0290_ScheduleResolvesSelectorBeforePersistingExactEnvironmentRef(t *testing.T) {
	now := time.Unix(1_700_000_000, 0)
	svc, schedStore := newScheduleService(t, now)
	ctx := context.Background()
