...
func TestADR_0288_ScopedWorktreeSelectorsFailClosed(t *testing.T) {
...
func TestADR_0288_NoFSDiscoveryDoesNotInvokeFilesystemProviders(t *testing.T) {
	store := &placementStoreSpy{Store: memstore.New()}
	provider := &placementProviderSpy{}
...
func TestADR_0288_ClearSessionIsLeaseSafeAndNonDestructive(t *testing.T) {
	store := &placementStoreSpy{Store: memstore.New()}
	provider := &placementProviderSpy{}
