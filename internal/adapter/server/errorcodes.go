...
var errorRegistry = []errorCodeEntry{
	...
	{Sentinel: ErrArtifactsUnavailable, Code: "artifacts_unavailable", GRPC: codes.Unimplemented, HTTPStatus: http.StatusNotImplemented, Title: "Artifacts are unavailable"},
