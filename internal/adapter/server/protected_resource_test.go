...
func TestADR_0305_ProtectedResourceMetadata(t *testing.T) {
...
func TestADR_0305_MetadataFields(t *testing.T) {
	h := server.NewProtectedResourceHandler(protectedResourceProfile())
	rec := httptest.NewRecorder()
	h.ServeHTTP(rec, httptest.NewRequest(http.MethodGet, "/.well-known/oauth-protected-resource/mecatl/v1", nil))
...
func TestADR_0305_WellKnownRouting(t *testing.T) {
	h := server.NewProtectedResourceHandler(protectedResourceProfile())
...
func TestADR_0305_WellKnownPathDerivation(t *testing.T) {
...
func TestADR_0305_MetadataRejectsInvalidScopeToken(t *testing.T) {
...
func TestADR_0305_MetadataDisabledCompatibility(t *testing.T) {
...
func TestADR_0305_ChallengeMatrix(t *testing.T) {
	auth := server.NewAuthenticator(server.SecurityConfig{AuthToken: "static-token"})
	defer auth.Close()
...
func TestADR_0305_MetadataEndpointAndSubordinateChallenge(t *testing.T) {
	profile := protectedResourceProfile()
	auth := server.NewAuthenticator(server.SecurityConfig{AuthToken: "static-token"})
	defer auth.Close()
...
func TestADR_0305_ChallengeIsAlwaysGeneric(t *testing.T) {
	auth := server.NewAuthenticator(server.SecurityConfig{AuthToken: "static-token"})
	defer auth.Close()
	rec := httptest.NewRecorder()
...
func TestADR_0305_MetadataStandardFields(t *testing.T) {
