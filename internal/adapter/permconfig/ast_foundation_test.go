...
func TestPermconfigNodeDecoderShapeInventory(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"ExecutionSection", func() yaml.NodeUnmarshaler { return &ExecutionSection{} }},
		{"ExecutionMicroVMSection", func() yaml.NodeUnmarshaler { return &ExecutionMicroVMSection{} }},
		{"ExecutionGuestEgressSection", func() yaml.NodeUnmarshaler { return &ExecutionGuestEgressSection{} }},
