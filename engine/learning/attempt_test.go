...
func TestADR_0254_AdmissionProvenanceBindsCurrentPromptAndRejectsForgery(t *testing.T) {
	t.Parallel()
...
func TestADR_0254_AttemptSurfacesContainNoContentOrSecrets(t *testing.T) {
	t.Parallel()
