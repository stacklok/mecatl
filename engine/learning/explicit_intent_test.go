...
func TestADR_0254_ExplicitIntentUsesOnlyADRElevenFourHardStops(t *testing.T) {
	imperatives := []string{
		"create a skill",
		"make a skill",
		"build a skill",
...
func TestADR_0254_ExplicitIntentRequiresVerifiedCurrentPrincipalPrompt(t *testing.T) {
