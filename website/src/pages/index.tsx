...
function Hero() {
  return <section className={styles.hero}><div className={styles.heroInner}><div className={styles.heroText}><h1 className={styles.heroTitle}>The open source, <Link className={styles.heroTitleLink} to="/docs/building/cloud-native-harness">cloud-native harness</Link></h1><p className={styles.heroSubtitle}>Build and run capable agents with the same platform patterns you use for the rest of your software.</p><div className={styles.heroCtas}><Link className={styles.ctaPrimary} to="/docs/mecatui/getting-started">Use it now</Link><Link className={styles.ctaSecondary} to="/docs/building/cloud-native-harness">What is a cloud-native harness?</Link><Link className={styles.ctaSecondary} to="/docs/building/deployment/mecak8s">Run on Kubernetes</Link></div></div><div className={styles.heroMascot}><Link to="/colophon"><img src="/img/mecatito.png" alt="Mecatito, the Mecatl mascot, a Xoloitzcuintli puppy wearing a teal rope collar with Mesoamerican markings" className={styles.mascotImg} /></Link></div></div></section>;
}
