...
function Hero() {
  return <section className={styles.hero}><div className={styles.heroInner}><div className={styles.heroText}><h1 className={styles.heroTitle}>The open cloud-native harness for developers who are building platforms</h1><p className={styles.heroSubtitle}>We blew up the harness and then put it back together: more secure, more scalable, more extensible.</p><div className={styles.heroCtas}><Link className={styles.ctaPrimary} to="https://github.com/stacklok/mecatl">Start building with Mecatl</Link><Link className={styles.ctaSecondary} to="/docs">Explore the docs</Link><Link className={styles.ctaSecondary} to="https://discord.gg/stacklok">Join our Discord</Link></div></div><div className={styles.heroMascot}><img src="/img/mecatito.png" alt="Mecatito, the Mecatl mascot, a Xoloitzcuintli puppy wearing a teal rope collar with Mesoamerican markings" className={styles.mascotImg} /></div></div></section>;
}
