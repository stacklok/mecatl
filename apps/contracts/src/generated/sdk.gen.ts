...
export const getPublicStatus = <ThrowOnError extends boolean = false>(options?: Options<GetPublicStatusData, ThrowOnError>): RequestResult<GetPublicStatusResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetPublicStatusResponses, unknown, ThrowOnError>({ url: '/api/v1/status', ...options });
