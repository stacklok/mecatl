...
export const getPublicStatusOptions = (options?: Options<GetPublicStatusData>) => queryOptions<GetPublicStatusResponse, DefaultError, GetPublicStatusResponse, ReturnType<typeof getPublicStatusQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
