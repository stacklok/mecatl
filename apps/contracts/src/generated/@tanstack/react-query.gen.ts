...
export const getSoulInspectionQueryKey = (options?: Options<GetSoulInspectionData>) => createQueryKey('getSoulInspection', options);

export const getSoulInspectionOptions = (options?: Options<GetSoulInspectionData>) => queryOptions<GetSoulInspectionResponse, GetSoulInspectionError, GetSoulInspectionResponse, ReturnType<typeof getSoulInspectionQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getSoulInspection({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getSoulInspectionQueryKey(options)
});

export const getSessionWorktreesQueryKey = (options: Options<GetSessionWorktreesData>) => createQueryKey('getSessionWorktrees', options);

export const getSessionWorktreesOptions = (options: Options<GetSessionWorktreesData>) => queryOptions<GetSessionWorktreesResponse, GetSessionWorktreesError, GetSessionWorktreesResponse, ReturnType<typeof getSessionWorktreesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getSessionWorktrees({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getSessionWorktreesQueryKey(options)
});
