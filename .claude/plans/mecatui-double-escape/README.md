...
- **Status:** complete
- **Scope:** one focused mecatui UI task for the physical, non-remappable double-Escape draft-clear gesture, repeat filtering, generation-tagged expiry, owner precedence, `clearPrompt` cleanup, help/docs, and scoped goldens.
