...
7. Follow ADR 0291 for high-level TS get/fork/source/debug paths: unrepresentable external IDs omit affinity; only explicit `withSessionAffinity` throws, and degrade removes stale caller affinity headers.
