...
7. Follow ADR 0293 for high-level TS get/fork/debug paths: unrepresentable external IDs omit affinity; only explicit `withSessionAffinity` throws, and degrade removes stale caller affinity headers.
