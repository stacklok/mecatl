...
var modelsSymbolHomes = map[string]string{
	...
	"modelsRowBudgetFor": "models_surface.go", "filterModels": "models_surface.go", "clampModelsCursor": "models_surface.go",
