...
type templateWorkspace struct{ Location, Basename templateText }
...
func newTemplateInput(input Input) templateInput {
	return templateInput{
		...
		Workspace:  templateWorkspace{escapeTemplateText(input.Workspace.Location), escapeTemplateText(input.Workspace.Basename)},
