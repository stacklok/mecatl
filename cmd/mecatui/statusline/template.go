...
type templateWorkspace struct{ Location, Name templateText }
...
func newTemplateInput(input Input) templateInput {
	return templateInput{
		...
		Workspace:  templateWorkspace{escapeTemplateText(input.Workspace.Location), escapeTemplateText(input.Workspace.Name)},
