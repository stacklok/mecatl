...
- **[Client integration guide](https://github.com/stacklok/mecatl/blob/main/user-docs/building/deployment/grpc-http.md)** — start here to discover the gRPC and HTTP/SSE contracts, streaming lifecycle, generated Go bindings, and driver protocol.
