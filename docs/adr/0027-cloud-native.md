...
**Harness-context re-audit (List 1 / List 2 — ADR 0357).** List 1 row 76 inventories process snapshots, session generations, and in-flight accounting. List 2 row 48 explicitly records their reset-by-design treatment; no durable harness-context reference is added.
