# ADR 0329: Broker replacement uses fresh outer authority over retained custody

- Status: Proposed (implementation in progress)
- Date: 2026-09-23
- **Supersedes:** none; complements ADR 0328
...
- `docs/adr/0328-bounded-singleton-mcp-broker-correctness.md`
