...
The sibling repos (atrium, airlock, titlani, tequitl) converged on a spine
...
before one PR. titlani and tequitl run the leanest variant; atrium adds a
two-PR model and repo-specific specialists that don't apply here.

## Decision

Adopt the titlani/tequitl spine variant, adapted to mecatl's anchors:
