...
- [0057 — MCP server notifications](./0057-mcp-server-notifications.md) *(deferred “no live catalog mutation” decision proposed to be superseded by 0350; notification transport, bounded lazy-list, reconnect, and teardown decisions retained)*
- [0350 — Reconcile stale direct MCP source snapshots](./0350-mcp-source-reconciliation.md) *(proposed; preserves exact-name authority and supersedes 0057 only for its deferred “no live catalog mutation” decision)*
