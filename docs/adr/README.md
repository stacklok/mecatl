...
- [0367 — Local microVM execution environments and developer-only release activation](./0367-microvm-execution-environments.md)
- [0365 — Prepare Darwin VirtioFS ownership and supervise the direct runner](./0365-microvm-darwin-xattr-ownership.md) *(proposed; partially supersedes ADR 0367's macOS platform deferral if accepted; Linux amd64 remains authoritative)*
...
- [0368 - Require evidence before Jev can clear guardrail reviews](./0368-evidence-before-jev-guardrail-authority.md) *(proposed; evaluation precedes any Jev guardrail authority)*
