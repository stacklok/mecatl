...
- [0247 — mecatui generated status lines](./0247-mecatui-status-line.md) *(superseded by 0284)*
- [0284 — Hardened status-command output and environment extension](./0284-hardened-status-command-boundary.md)
