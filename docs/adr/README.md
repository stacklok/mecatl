...
- [0285 — Predictable actionable mecatui session handles](./0285-predictable-mecatui-session-handles.md) *(superseded by 0350)*
- [0350 — Raw readable mecatui session handles](./0350-raw-readable-mecatui-session-handles.md) *(ordinary 12-display-column control-stripped raw handles; supersedes ADR 0285 without changing debugger evidence/incarnation handles)*
