...
- [0343 - Claude prompt caching routes through a native Messages surface](./0343-unified-prompt-cache-dialect.md) *(supersedes ADR 0100 only for its OpenRouter TTL deferral; extends ADR 0334's protocol-specific-provider pattern to OpenRouter)*
