...
- [0250 — Bounded scoped HTTPS keep-alive reuse for OIDC](./0250-bounded-scoped-https-keepalive-oidc.md) *(supersedes ADR 0235's keep-alive policy and ADR 0244's credential-recovery classification only)*
