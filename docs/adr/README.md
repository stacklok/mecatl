...
- [0036 — `engine/` is its own Go module (monorepo via `go.work`)](./0036-engine-module.md) *(workspace checksum tracking superseded by 0237)*
- [0237 — Treat `go.work.sum` as generated workspace metadata](./0237-generated-go-work-sum.md) *(supersedes ADR 0036's workspace checksum tracking decision)*
