...
- [0358 — Studio exposes coarse status and completes browser login in a popup](./0358-studio-anonymous-status-and-popup-login.md) *(proposed; anonymous status, authenticated runtime, and same-origin callback messaging)*
