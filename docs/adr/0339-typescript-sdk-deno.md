# ADR 0339 - Deno uses the TypeScript SDK HTTP/SSE entry point

- Status: Accepted
- Date: 2026-09-11
- Superseded by: [ADR 0340](./0340-typescript-sdk-deno-command.md), for the public entry-point and
  local-process decisions; [ADR 0341](./0341-typescript-sdk-deno-grpc.md), for the HTTP-only
