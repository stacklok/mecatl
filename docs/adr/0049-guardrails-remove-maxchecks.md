...
The later contextual reviewer removes content-length skips entirely; see [ADR 0363](./0363-contextual-investigative-guardrails.md).
...
**Unchanged at the time:** the engine-layer routing, verdict parse, recursion guard, fail-open/closed posture, operator-tier-only enforcement, and kill switch. Later contextual-review changes are recorded by [ADR 0363](./0363-contextual-investigative-guardrails.md).
