...
**Unchanged at the time:** the threat model, quarantine, framing discipline, verdict parse, enforcement modes, checker-down posture, and recursion prevention. Later contextual-review changes are recorded by [ADR 0363](./0363-contextual-investigative-guardrails.md).
