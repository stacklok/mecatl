...
- Superseded by: ADR 0313 (Decisions 8–9, in part); [ADR 0328](./0328-typescript-sdk-npmjs-stacklok-oss.md) (npmjs cutover and `@stacklok-oss` package name); [ADR 0347](./0347-run-id-addressed-prompt-free-controls.md) (Decision 3's teams-only ergonomic-resource constraint)
