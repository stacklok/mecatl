# ADR 0306 — Bounded singleton MCP broker correctness
...
ADR 0304 selected process-bound remote attachments and prohibited application retries after
...
values that did not represent the client and network boundaries described by ADR 0305.
...
ADR 0305 remains the topology decision; this amendment completes its resource inventory and the
...
- [ADR 0305 — Single-replica production topology](./0305-single-replica-mcp-broker-topology.md)
