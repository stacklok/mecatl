...
system of record** rather than a snapshot store. Atrium is the motivating consumer:
...
- **Event-log-SoR hosts get a first-class, documented rehydration path.** Atrium can
