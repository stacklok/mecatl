...
| MCP authorization-code client | ✅ official Go SDK public profile qualified offline (RFC 9728 + S256 + RFC 8707, ADR 0109) · ⛔ mecatl OAuth controller/browser callback/credential persistence and production wiring (#518) | [0109](../adr/0109-mcp-oauth-sdk-profile.md) | [extensibility](../architecture/extensibility.md) |
