...
| Soul / persona + user-model | ✅ Phase 1 + 2a + 2b + Phase 3 items 1–3 · ✅ optional learning invocation seam (#507) · ⛔ candidate/review queue (#509) | [SOUL-SPIKE.md](../adr/0011-soul-and-user-model.md) · [0106](../adr/0106-optional-learning-seam.md) | [memory](../architecture/memory.md) |
