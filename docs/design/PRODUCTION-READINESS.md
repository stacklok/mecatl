...
| Local repository microVM environments | ✅ Linux amd64 KVM implementation, deterministic gate, and manual public-API qualification · 🔨 Darwin arm64 implementation in PR 580: fixed-65532 VirtioFS xattr preparation, strict RW/RO mounts, safe direct-child launch supervisor, shared Unix daemon flock, macOS 15+/HVF admission, and current-platform development artifacts · ⛔ native Apple Silicon real-VM journey, macOS CI result for the unpushed change, non-publishing signed-candidate qualification, and released Darwin support · ⛔ Linux arm64 admission | [0350](../adr/0350-microvm-execution-environments.md) · proposed [0351](../adr/0351-microvm-darwin-xattr-ownership.md) | [microVM environments](../architecture/microvm-environments.md) |
