...
| Direct MCP OAuth dynamic client registration | ✅ trusted named local profiles, durable CAS registration, generation-bound no-refresh access grant, explicit reset/retry recovery, restart reuse, expiry-to-login-required, and offline protocol/security gates shipped · ⛔ complete resource-bound public-client refresh ([issue #1355](https://github.com/stacklok/mecatl/issues/1355)) · ⛔ live local-mecatui qualification remains human/environment-dependent | [0325](../adr/0325-direct-mcp-dcr.md) | [credential store](../architecture.md#internal-credential-store) |
