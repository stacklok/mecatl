...
| MCP authorization-code client | ✅ official Go SDK public profile qualified offline (ADR 0109) · ✅ adapter-local persistent controller for constrained preregistered/CIMD embeddings (ADR 0110; unwired) · ⛔ browser callback UX, key acquisition/identity routing, CLI/composition, DCR, and enforceable pre-presentation SDK metadata-profile gate (#522/#523/upstream) | [0109](../adr/0109-mcp-oauth-sdk-profile.md) · [0110](../adr/0110-mcp-oauth-controller.md) | [extensibility](../architecture/extensibility.md) |
