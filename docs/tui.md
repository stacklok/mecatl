...
accounting is governed by [ADR 0303](adr/0303-canonical-durable-token-accounting.md).
See [ADR 0302](adr/0302-session-title-generation-and-auxiliary-usage.md).
