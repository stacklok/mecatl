...
accounting is governed by [ADR 0302](adr/0302-canonical-durable-token-accounting.md).
See [ADR 0301](adr/0301-session-title-generation-and-auxiliary-usage.md).
