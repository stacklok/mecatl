...
session ID and bounded display metadata, never the exact private `EnvironmentRef`.
  - verify: `TestADR_0288_CreateSessionAcceptsOnlyDefaultOrNoFS`
...
choices are indistinguishable and never fall back to a default.
  - verify: `TestADR_0288_ScopedWorktreeSelectorsFailClosed`
...
`EnvironmentRef`, or path-shaped selector. Old path-bearing requests are unsupported.
  - verify: `TestADR_0288_PublicHarnessContractContainsNoFilesystemPaths`
...
identify its configured physical root.
  - verify: `TestADR_0288_SessionAndSnapshotPersistOnlyEnvironmentRef`
...
alternate authority path.
  - verify: `TestADR_0288_LegacyDuplicatePlacementStateIsUnsupported`
...
revision metadata.
  - verify: `TestADR_0288_DiscoveryIsSessionScopedAndOwnerAuthorized`
...
result without invoking a filesystem/default resolver, command source, or worktree lister.
  - verify: `TestADR_0288_NoFSDiscoveryDoesNotInvokeFilesystemProviders`
...
registry/map.
  - verify: `TestADR_0288_WorktreeSelectorIsScopedAndMatchedAgainstCurrentInventory`
...
posture; the response exposes no exact private ref or path.
  - verify: `TestADR_0288_ClearSessionCreatesEmptyInheritedSuccessor`
...
client binding.
  - verify: `TestADR_0288_ClearSessionIsLeaseSafeAndNonDestructive`
...
and original placement scope before access.
  - verify: `TestADR_0288_ArtifactHandlesCannotReplayAsPlacementSelectors`
...
no fork root, placement path, exact private ref, or reusable selector.
  - verify: `TestADR_0288_DelegationObservabilityContainsNoPlacementPath`
...
intent; models cannot choose schedule selectors.
  - verify: `TestADR_0288_ScheduleResolvesSelectorBeforePersistingExactEnvironmentRef`
...
`Reattach`. No public Harness/HTTP/client mapper projects that ref.
  - verify: `TestADR_0288_DriverStorageCarriesExactPrivateEnvironmentRef`
...
placement; mismatch is rejected and cwd cannot select or construct authority.
  - verify: `TestADR_0288_ACPBindAndLoadAssertConfiguredPlacement`
...
only.
  - verify: `TestADR_0288_PathSurfaceInventoryEnforcesPublicBoundary`
...
introduced.
  - verify: `TestADR_0288_PlacementReauditInventoriesEphemeralSelectorKey`
