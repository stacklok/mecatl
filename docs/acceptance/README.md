...
- [Mecatui bounded scroll and selection control](mecatui-bounded-scroll-selection.md) — establishes package-private physical-line browsing and logical-item cursor layers, then proves consistent bounds, styling, wheel ownership, and click-to-cursor behavior in Agents, Models, and Skills. Status: proposed.
