...
- [Jev guardrail evaluation](jev-guardrail-evaluation.md) - synthetic paired review evidence and separately authorized live comparison before any Jev result can affect contextual guardrail decisions. Status: draft.
