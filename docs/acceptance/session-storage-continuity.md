...
**Status:** draft historical record, partially superseded 2026-09-02 by [ADR 0290](../adr/0290-server-owned-session-placement.md). Storage migration/cleanup landed; writable legacy-adoption criteria and their deleted proofs are no longer current acceptance claims.
