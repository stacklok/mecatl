...
**Status:** draft historical record, partially superseded 2026-09-02 by [ADR 0280](../adr/0280-server-owned-session-placement.md). Storage migration/cleanup landed; writable legacy-adoption criteria and their deleted proofs are no longer current acceptance claims.
