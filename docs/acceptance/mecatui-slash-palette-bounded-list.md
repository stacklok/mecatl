...
**Status:** in-progress, 2026-09-23. The operator explicitly authorized this implementation-branch amendment without a separate amendment PR: the card has a terminal-derived fixed width, entries have a three-line cap, and command/description presentation distinguishes hierarchy.
