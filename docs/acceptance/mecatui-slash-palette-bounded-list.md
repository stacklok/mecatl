...
**Status:** landed, 2026-09-23. The implementation candidate, including the operator-approved presentation amendment, passed its gates and review; this transition becomes authoritative when its implementation PR merges.
