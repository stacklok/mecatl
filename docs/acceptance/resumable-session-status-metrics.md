...
**Status:** in-progress, 2026-09-24. The implementation candidate requires diagnosis of the outstanding embedded `--resume-latest` occupancy reproduction before it can be landed.
