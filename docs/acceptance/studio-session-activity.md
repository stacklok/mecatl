...
**Status:** landed, 2026-09-24, in the stacked implementation candidate only. The Plan / Interface PR remains proposed pending human approval. Reconciled with the merged [#1847 Plan / Interface PR #1880](https://github.com/stacklok/mecatl/pull/1880) and [implementation PR #1886](https://github.com/stacklok/mecatl/pull/1886).
