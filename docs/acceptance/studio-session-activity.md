...
**Status:** proposed, 2026-09-24. Reconciled with the proposed [#1847 Plan / Interface PR](https://github.com/stacklok/mecatl/pull/1880) and reviewed for Plan / Interface approval.
...
- #1847 can change message composition before implementation. Reconcile its approved inline anchor and stream consumption without changing this three-family event contract; material drift returns to Plan / Interface review.
