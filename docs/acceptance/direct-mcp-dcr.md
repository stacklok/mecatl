...
1. Before implementation orchestration, this plan is human-marked `approved`, ADR 0319 is accepted in the merged baseline, and ADR 0319's supersession metadata explicitly governs the public-`none` and durable-DCR exceptions to ADRs 0219 and 0220.
...
- The merged approved baseline must accept ADR 0319 and make its public-`none` and durable-DCR supersession of ADRs 0219/0220 explicit before orchestration; the proposed documents intentionally do not authorize implementation yet.
