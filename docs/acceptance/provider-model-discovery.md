...
5. In the implementation PR, update the owning [model-selection guide](../../user-docs/features/choose-models.md) (`user-docs/features/choose-models.md`) and [deployment guidance](../../user-docs/building/deployment/mecated.md) (`user-docs/building/deployment/mecated.md`) for first-demand/retry behavior and safe recovery, following `user-docs/_README.md`; run `task site:build`. This plan PR publishes no changed runtime instructions.
