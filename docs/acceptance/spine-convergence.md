...
**Status:** draft, 2026-07-24. Converges the atrium/titlani/tequitl spine into mecatl.
...
mechanism titlani/tequitl run, per the `verify:` contract in
...
| Converging the atrium-only specialists (arch-*, kind-*, ui-*) | never — not mecatl's domain | atrium-specific |
