...
export interface McpInventory {
    ...
    // Warning: (ae-forgotten-export) The symbol "RefreshMcpSourcesRequest" needs to be exported by the entry point node.d.ts
    // Warning: (ae-forgotten-export) The symbol "RefreshMcpSourcesResponse" needs to be exported by the entry point node.d.ts
