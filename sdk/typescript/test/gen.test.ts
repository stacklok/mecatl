...
import { HarnessService, LocalSessionContextService, ScheduleService } from "../src/gen/index.js";
...
describe("protobuf-es generation", () => {
  it("no driver protocol output is generated", async () => {
    ...
    expect(
      ...
      "mecatl/v1/harness_pb.ts",
      "mecatl/v1/local_session_context_pb.ts",
      "mecatl/v1/schedule_pb.ts",
    ]);
  });
  ...
  it("generated descriptors construct a typed Connect client", () => {
    ...
    const localContextClient: Client<typeof LocalSessionContextService> = createClient(
    ...
    expect(LocalSessionContextService.typeName).toBe("mecatl.v1.LocalSessionContextService");
    expect(harnessClient.createSession).toBeTypeOf("function");
    expect(scheduleClient.listSchedules).toBeTypeOf("function");
    expect(localContextClient.getLocalSessionContext).toBeTypeOf("function");
  });
});
