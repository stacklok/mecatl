...
- [Hook system](/building/what-you-get/hooks.md) — the `port.HookRunner` lifecycle hooks that fire around tool calls.
- [The agent loop](/building/what-you-get/agent-loop.md) — how the loop drives turns, emits events, and reaches terminal states.
