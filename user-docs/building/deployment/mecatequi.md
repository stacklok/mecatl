...
credential and restart the job. See [MCP client](/building/what-you-get/mcp-client.md).
...
- [Pick your deployment shape](/building/getting-started/deployment-decision.md) — comparison of mecatequi, mecated, mecak8s, and the embedded engine.
- [Run mecated standalone](/building/deployment/mecated.md) — the long-running daemon with interactive clients, durable sessions, and multi-replica support.
- [Cloud-native k8s with mecak8s](/building/deployment/mecak8s.md) — Redis-backed, PVC-free Kubernetes deployment.
- [Permissions & guardrails](/building/what-you-get/permissions.md) — the posture ladder, allow/ask/deny rules, and the headless ask reviewer.
