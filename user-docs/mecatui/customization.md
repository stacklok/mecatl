...
with `status_customization`. Project files and remote servers cannot configure this
client-only setting. Choose either a responsive template set or a local executable.
The client sends command input only through standard input.
