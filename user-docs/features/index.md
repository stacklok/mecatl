...
Each feature page should answer these questions in order:

1. What does the feature help you do?
2. Which deployment shapes support it?
3. How do you enable or use it?
4. What configuration and permissions does it require?
5. What limitations or deployment gaps apply?
6. What should you read or do next?
